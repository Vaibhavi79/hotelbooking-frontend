        ...
        <div className="home">
            <section>
                <header className="header-banner">
                    <img src="./images/bg2.jpg" alt="Hotel" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>Welcome to <span className="phegon-color">Skyline Suites</span></h1> <br/>
                        <h3>Where Elegance Touches the Sky</h3>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Skyline Suites</span></h2>
